<!--[if lt IE 9]>
<script src="${ctx}/assets/global/js/respond.min.js"></script>
<script src="${ctx}/assets/global/js/excanvas.min.js"></script>
<![endif]-->
<script src="${ctx}/assets/global/js/jquery-1.9.1.min.js" type="text/javascript"></script>
